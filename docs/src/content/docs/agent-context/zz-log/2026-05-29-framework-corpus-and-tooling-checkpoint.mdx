...
Crosswalker's role in that model: the **Lane 2 control + crosswalk spine** (see the [two-lane framing](/crosswalker/concepts/related-tooling/#two-lanes-of-compliance-tooling)), kept as plain-text notes you own. The shared model itself is the [unified risk model](/crosswalker/concepts/unified-risk-model/).
...
- **[Two lanes of compliance tooling](/crosswalker/concepts/related-tooling/#two-lanes-of-compliance-tooling)** — Lane 1 (regulatory/CMS, atomic unit = obligation) vs Lane 2 (control/framework ops, atomic unit = control). Crosswalker is Lane 2.
...
- [Related tooling — GRC/audit/compliance platforms + two lanes](/crosswalker/concepts/related-tooling/)
- [Unified risk model — the shared CRI-centered model](/crosswalker/concepts/unified-risk-model/)
