...
Crosswalker's role in that model: the **Lane 2 control + crosswalk spine** (see the [two-lane framing](/crosswalker/concepts/related-tooling/#two-lanes-of-compliance-tooling)), kept as plain-text notes you own. The shared model itself is the [unified risk model](/crosswalker/examples/unified-risk-model/).
