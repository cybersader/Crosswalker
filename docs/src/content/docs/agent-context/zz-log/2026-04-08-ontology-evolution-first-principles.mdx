...
- [User-first ontology maintenance](/crosswalker/agent-context/zz-log/2026-04-09-user-first-ontology-maintenance/) — the experience layer (follow-on)
- [Atomic operations research](/crosswalker/agent-context/zz-log/2026-04-09-atomic-operations-research/) — literature survey proving the primitives
...
- [Ontology lifecycle](/crosswalker/concepts/ontology-lifecycle/) — the 5 phases
- [Data model resilience](/crosswalker/agent-context/data-model-resilience/) — resilience patterns for the data model
