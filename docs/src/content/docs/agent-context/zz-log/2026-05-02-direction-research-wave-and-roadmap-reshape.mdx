...
:::caution[This log is bloated — read the TL;DR and third-wave log instead]
**👉 [2026-05-02 Direction commitments (TL;DR)](/crosswalker/agent-context/zz-log/2026-05-02-direction-commitments-tldr/)** is the concise concluding artifact — what's locked in, what's still researching, what's parked.

**👉 [2026-05-02 Direction third-wave shifts log](/crosswalker/agent-context/zz-log/2026-05-02-direction-third-wave-architectural-shifts/)** captures the deltas from the *third* research wave (Ch 14/15/16) that landed later on 2026-05-02 — Tier 2 confirmed-and-extended, Tier 3 default flipped from AGE to Fuseki/oxigraph-server, audit-trail 4-tier model adopted with OpenTimestamps as the new T2 default.

This long log is the **research record** for the second-wave bloated 9-deliverable research wave (Ch 08–13). Read it for context; act from the TL;DR + third-wave log.
:::
...
3. Marks the resolved challenges and spins up [Challenge 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/) for the engines surfaced *during* Ch 11 research (§4)
...
**Full deliverable**: [Ch 08: Is git history a tenable compliance audit trail?](/crosswalker/agent-context/zz-research/2026-05-02-challenge-08-git-audit-trail/). **Brief**: [Challenge 08](/crosswalker/agent-context/zz-challenges/archive/08-git-history-audit-trail-tenability/).
...
**Full deliverable**: [Ch 09: UUID/CWUUID cross-cutting identifier strategy](/crosswalker/agent-context/zz-research/2026-05-02-challenge-09-uuid-cwuuid/). **Brief**: [Challenge 09](/crosswalker/agent-context/zz-challenges/archive/09-uuid-cwuuid-cross-cutting-strategy/).
...
**Full deliverable**: [Ch 10: Graph→tabular bridging engine for the web-of-webs](/crosswalker/agent-context/zz-research/2026-05-02-challenge-10-graph-tabular/). **Brief**: [Challenge 10](/crosswalker/agent-context/zz-challenges/archive/10-graph-to-tabular-bridging-engine/).
...
[Full deliverable: Ch 13 — Modern attestation primitives](/crosswalker/agent-context/zz-research/2026-05-02-challenge-13-deliverable-a-attestation-primitives/). **Brief**: [Challenge 13](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/).
...
**Action**: spin up a narrower follow-on research challenge focused specifically on these primitives — resolved by [Challenge 13](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/) (deliverable summarized in §2.6 above; critical read in §3.6 below).
...
**New engines surfaced** — Grafeo (most consequential potential game-changer), Minigraf, CozoDB, SurrealDB-WASM, Comunica + N3 + HDT, cr-sqlite, sqlite-vec stack. **Spin up [Challenge 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/)**.
...
✅ **RESOLVED by 1 fresh-agent deliverable later on 2026-05-02 (third wave)**. Verdict: keep Ch 11 layered Tier 2 stack as production; add Tier 2-Lite (sqlite-wasm + sqlite-vec + simple-graph + recursive-CTE) and Comunica + N3 + HDT federation as additive extensions; track Grafeo and Minigraf with explicit, falsifiable [migration triggers](/crosswalker/agent-context/zz-log/2026-05-02-direction-third-wave-architectural-shifts/#24-migration-triggers-ch-14-7--preserved-verbatim-for-discoverability); reject SurrealDB (BSL + 12.6 MB bundle), cr-sqlite (stalled Oct 2024), CozoDB (no release since v0.7 in 2023). Synthesized in [third-wave log §2](/crosswalker/agent-context/zz-log/2026-05-02-direction-third-wave-architectural-shifts/#2-ch-14--tier-2-stack-confirmed-and-extended).
- [Ch 14 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-14-missed-engines/) — missed engines evaluation
- [Archived Challenge 14 brief](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/)

### 4.5 Challenge 15 — Audit-trail alternatives without external git tooling

✅ **RESOLVED by 1 fresh-agent deliverable later on 2026-05-02 (third wave)**. Verdict: adopt 4-tier model (T0/T1/T2/T3) with **OpenTimestamps `.ots` on signed chain checkpoints** as new T2 default; reposition the Ch 08+13 git+RFC3161+S3-Object-Lock+FRE 902 stack as one of three T3 options (others: eIDAS QTSA + W3C VC for EU; Sigstore Rekor v2 + in-toto for supply-chain). Crypto-agile PQC migration plan 2026→2032 ahead of NIST IR 8547 2035 deadline. Synthesized in [third-wave log §4](/crosswalker/agent-context/zz-log/2026-05-02-direction-third-wave-architectural-shifts/#4-ch-15--audit-trail-4-tier-model-adopted-git-stack-repositioned).
- [Ch 15 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-15-non-git-audit-trail/) — non-git audit-trail alternatives
- [Archived Challenge 15 brief](/crosswalker/agent-context/zz-challenges/archive/15-non-git-audit-trail-alternatives/)

### 4.6 Challenge 16 — Tier 3 stack reconsideration

✅ **RESOLVED by 1 fresh-agent deliverable later on 2026-05-02 (third wave)**. Verdict: **demote Apache AGE from default to optional fallback**; promote Apache Jena Fuseki as new Tier 3 default; document oxigraph-server as the lighter same-API alternative (architectural symmetry: same engine as Tier 2, just `oxigraph serve`); document layered Fuseki + DuckDB-on-server as power-user upgrade path; TerminusDB v12 as opt-in vault-mirror with small-vendor (DFRNT) risk explicitly flagged. Synthesized in [third-wave log §3](/crosswalker/agent-context/zz-log/2026-05-02-direction-third-wave-architectural-shifts/#3-ch-16--tier-3-default-flipped-from-age-to-fusekioxigraph-server).
- [Ch 16 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-16-tier-3-reconsideration/) — Tier 3 stack reconsideration
- [Archived Challenge 16 brief](/crosswalker/agent-context/zz-challenges/archive/16-tier-3-stack-reconsideration/)
...
- **Challenge 14** (created today): missed engines (Grafeo, Minigraf, CozoDB, SurrealDB-WASM, Comunica, cr-sqlite, sqlite-vec). [Brief published](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/).
...
- **Phase B′ — Run the third research wave**
  - Hand [Challenge 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/) to a fresh agent (engines that surfaced during Ch 11)
...
- Add a sentence: **Tier 1 audit-trail hardening (TSA + WORM + cert-export per Challenge 08) is deferred pending [Challenge 13 — modern attestation primitives](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/).**
...
- Add: **Tier 2 engine choice deferred pending [Challenge 11](/crosswalker/agent-context/zz-challenges/archive/11-tier-2-3-engine-deep-survey/); Datalog vs SQL fork for derivation deferred pending [Challenge 12](/crosswalker/agent-context/zz-challenges/archive/12-datalog-vs-sql-sssom-chain-rules/).**
...
- Per [Challenge 09 deliverable](/crosswalker/agent-context/zz-challenges/archive/09-uuid-cwuuid-cross-cutting-strategy/): UUIDv7 default, sha256 multibase CIDs for content-addressed (spine snapshots, schema releases), CURIEs for external references (controls, frameworks, ORCIDs)
...
- Links to [Challenge 11](/crosswalker/agent-context/zz-challenges/archive/11-tier-2-3-engine-deep-survey/)
...
- Links to [Challenge 12](/crosswalker/agent-context/zz-challenges/archive/12-datalog-vs-sql-sssom-chain-rules/)
...
- Links to [Challenge 13](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/)
...
- Alternative collapse-to-single-engine pending [Ch 14 evaluation of Grafeo](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/)
...
| **Layered Tier 2 vs single-engine collapse** | [Challenge 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/) deliverable (Grafeo viability) |
| **Bi-temporal Datalog (Minigraf) for SSSOM** | [Challenge 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/) |
...
- [Challenge 08: Git audit-trail tenability](/crosswalker/agent-context/zz-challenges/archive/08-git-history-audit-trail-tenability/) — ✅ resolved (Ch 13 follow-on)
- [Challenge 09: UUID/CWUUID strategy](/crosswalker/agent-context/zz-challenges/archive/09-uuid-cwuuid-cross-cutting-strategy/) — ✅ resolved
- [Challenge 10: Graph→tabular bridging engine](/crosswalker/agent-context/zz-challenges/archive/10-graph-to-tabular-bridging-engine/) — ✅ resolved (Ch 11+12 follow-on)
- [Challenge 11: Tier 2/3 engine deep survey](/crosswalker/agent-context/zz-challenges/archive/11-tier-2-3-engine-deep-survey/) — ✅ resolved (3 deliverables)
- [Challenge 12: Datalog vs SQL for SSSOM chain rules](/crosswalker/agent-context/zz-challenges/archive/12-datalog-vs-sql-sssom-chain-rules/) — ✅ resolved (2 deliverables)
- [Challenge 13: Modern attestation primitives](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/) — ✅ resolved
- 🆕 [Challenge 14: Missed engines evaluation](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/) — Phase 2 follow-on; spun up today
