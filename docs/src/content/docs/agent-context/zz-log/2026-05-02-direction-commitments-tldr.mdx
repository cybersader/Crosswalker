...
| 10 | OSCAL native support — web-of-webs placement | ⏳ Mapped here; promotion to architectural concern pending user input | [§3.3](#33-oscal-native-support--placement-in-the-web-of-webs) |
...
**Score after third wave**: 8 confirmed (#1, #2, #3, #4, #5, #6, #7, #8). 1 pending user input (#10 OSCAL). 1 parked (#9 LinkML). 1 resolved-track (#11 Grafeo).
