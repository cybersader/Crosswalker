...
| **ISO 31000** | **Risk** — but defined as "effect of uncertainty *on objectives*" (bidirectional) |
...
| Name | **Unified Control Assurance and Risk Model** — names the three useful practitioner lenses (Control / Assurance / Risk). | **chosen** |
