...
- **E2E suite for the view DOM rendering** — pending until WebdriverIO env is reliably available. Manual test guide (`TEST_PHASE3_PIVOT_VIEW.md`) covers 7 scenarios end-to-end in the meantime.
