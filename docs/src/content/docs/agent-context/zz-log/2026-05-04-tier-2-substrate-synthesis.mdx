...
This trigger applies to **how** we ship sqlite-vec, not whether. Per the [v0.1.5 milestone](/crosswalker/reference/roadmap/milestones/v0-1-5-tier-2-sidecar/), v0.1.5 ships **WASM-B** via `bun add sqlite-vec-wasm-demo@0.1.9` (the official upstream npm package from asg017). This is a pragmatic v0.1 default that **knowingly violates the [§2.2 ~600 KB plugin budget](#1-the-verdict)** — the demo artifact is 1.8 MB compressed. User accepted this tradeoff to ship vec from day 1 (decision: 2026-05-05). Re-evaluate when ANY of:
