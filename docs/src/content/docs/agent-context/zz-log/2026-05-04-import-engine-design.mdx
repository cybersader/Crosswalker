...
Real recipes compose these. The full target-structure expressivity question is the subject of [Ch 22](/crosswalker/agent-context/zz-challenges/22-target-structure-expressivity/). For this design log: the four mechanisms are the *primitive Obsidian affordances* the engine has to work with; recipes choose which to use at which level.
...
- [Ch 22 target-structure expressivity](/crosswalker/agent-context/zz-challenges/22-target-structure-expressivity/) — the open research that informs the recipe DSL
