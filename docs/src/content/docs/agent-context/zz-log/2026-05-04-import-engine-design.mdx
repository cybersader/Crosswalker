...
|---|---|---|---|
| **Bundled engine implementation language** | TypeScript/Bun (in-plugin); Python (external CLI); Hybrid; Rust/Go-WASM; JVM | Hybrid (TS in-plugin + external Python) | **Research-needed** — user flagged this as "could be dicey." Spun up [Ch 23](/crosswalker/agent-context/zz-challenges/23-bundle-engine-language/) for focused investigation against bundle-size, mobile portability, install friction, contributor pool, 5-year drift |
...
| 10 | **Ch 23 — Bundle engine language research** | `zz-challenges/23-bundle-engine-language` | ✅ brief landed 2026-05-04; deliverable pending |
