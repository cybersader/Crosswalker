...
- **Authored by**: [NIST](/crosswalker/reference/registry/nist/)
...
- **Format**: Available as CSV, XLSX, [OSCAL](/crosswalker/reference/registry/oscal/) XML/JSON
...
- **Crosswalks**: Maps to 800-53, [CIS](/crosswalker/reference/registry/cis/), [ISO](/crosswalker/reference/registry/iso/) 27001

### CIS Controls v8
- **Authored by**: [CIS](/crosswalker/reference/registry/cis/) (Center for Internet Security)
...
- **Crosswalks**: Maps to [NIST](/crosswalker/reference/registry/nist/) CSF, 800-53

### MITRE ATT&CK
- **Authored by**: [MITRE](/crosswalker/reference/registry/mitre/)
...
- **Related**: D3FEND (defensive), ENGAGE (deception). Maintained crosswalks to NIST 800-53 via [CTID](/crosswalker/reference/registry/ctid/).

### CRI Profile v2.0
- **Authored by**: [CRI](/crosswalker/reference/registry/cri/) (Cyber Risk Institute)
- **Structure**: Function > Category > Subcategory > Diagnostic Statement
- **Size**: Comprehensive financial sector framework
- **Crosswalks**: [NIST](/crosswalker/reference/registry/nist/) CSF, [FFIEC](/crosswalker/reference/registry/ffiec/), CISA CPG
...
### Mapping complexity
- [CRI](/crosswalker/reference/registry/cri/) maps to [NIST](/crosswalker/reference/registry/nist/) CSF, [FFIEC](/crosswalker/reference/registry/ffiec/) CAT, CISA CPG, and other financial-sector standards
