...
| [Registry: CRI](/crosswalker/reference/registry/cri/) · [SCF](/crosswalker/reference/registry/scf/) · [STRM](/crosswalker/reference/registry/strm/) · [NIST](/crosswalker/reference/registry/nist/) · [OLIR](/crosswalker/reference/registry/olir/) | Spine-candidate facts + the existing crosswalk infrastructure |
...
| [v0.1 architectural commitments](/crosswalker/) — schema-as-primitive, 5-mechanism recipe grammar | The engine is **spine-agnostic** by design; a spine may be a UX/profile concern, not an engine one |
