...
Resolved by the [Ch 19 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-19-overengineering-stress-test/) — adversarial verdict: radically simplify with narrow tiered escape hatch. Five concrete arguments (competitive landscape hides crosswalk complexity from users; SSSOM has zero GRC adoption; audit trail over-specified vs FRE 902 / SOC 2 / ISO 27001 actual requirements; 5 MB three-engine bundle is 10–50× Obsidian median and overkill for the data volume; concrete simple-default proposal). The [v0.1 stack-pivot log](/crosswalker/agent-context/zz-log/2026-05-02-v0-1-initial-stack-pivot/) was the response — adopted with calibrations (Tier 2 sqlite-wasm sidecar bundled in v0.1; SSSOM/STRM hybrid wire format; Junction Notes from Ch 07 preserved; T1 audit default). Brief preserved as originally written.
:::
