...
Resolved by the cascade: [Ch 10 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-10-graph-tabular/) (initial 3-tier hybrid recommendation), then [Ch 11 (3 deliverables)](/crosswalker/agent-context/zz-research/) refining Tier 2/3 engine choices, then [archived Ch 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/) confirming the layered Tier 2 stack, then [archived Ch 16](/crosswalker/agent-context/zz-challenges/archive/16-tier-3-stack-reconsideration/) flipping the Tier 3 default to Fuseki/oxigraph-server. Final shape committed in the [v0.1 stack-pivot log](/crosswalker/agent-context/zz-log/2026-05-02-v0-1-initial-stack-pivot/). Brief preserved as originally written.
:::

:::note[Rerun filed 2026-05-08 — Ch 35]
The 2026-05-08 alignment review surfaced that this challenge's verdicts were made under a GRC framing where vault sizes are bounded (~5K controls × 8 frameworks). Under the [ontology-web framing](/crosswalker/concepts/ontology-web-querying/), graph→tabular bridging at BioPortal/UMLS/OBO Foundry scale needs re-examination. **A fresh rerun of this challenge has been filed as [Ch 35](/crosswalker/agent-context/zz-challenges/35-graph-to-tabular-bridging-rerun/)** — original brief stays archived; the rerun produces a NEW deliverable that may revise or override the verdicts above.
:::
