...
date: 2026-05-02
sidebar:
  label: "Ch 15 · Non-git audit trail"
  order: 1015
---
...
- **Follow-on to [Ch 08](/crosswalker/agent-context/zz-challenges/archive/08-git-history-audit-trail-tenability/) and [Ch 13](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/)** — those committed to a git-centric audit trail; this evaluates the alternatives for environments where git isn't viable
...
- **Relates to [Ch 14](/crosswalker/agent-context/zz-challenges/archive/14-missed-engines-evaluation/)** — cr-sqlite (CRDT SQLite) was flagged there; if Ch 14 picks cr-sqlite for collaborative editing, audit trail leverages the same primitive
