...
Resolved by the [Ch 13 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-13-deliverable-a-attestation-primitives/) (confirms Ch 08 floor; adds in-toto attestations as mandatory; offers Sigstore/gitsign as configurable alternative; SLSA L1→L2→L3 progression). Absorbed into the [v0.1 stack-pivot §3.1 audit-trail decision](/crosswalker/agent-context/zz-log/2026-05-02-v0-1-initial-stack-pivot/) which defaults to T1 (git + signed commits) for v0.1 and reframes T2/T3 (including in-toto / Sigstore Rekor / OpenTimestamps / eIDAS QTSA) as opt-in compliance-export mode for v1.0+. Brief preserved as originally written.
:::
