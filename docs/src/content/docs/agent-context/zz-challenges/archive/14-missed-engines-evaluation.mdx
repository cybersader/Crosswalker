...
- **Phase 2 follow-on to [Challenge 11](/crosswalker/agent-context/zz-challenges/archive/11-tier-2-3-engine-deep-survey/)** — Ch 11's three deliverables converged on a layered Tier 2 stack but explicitly flagged engines they hadn't evaluated. This challenge resolves those.
- **Coordinates with [Challenge 12](/crosswalker/agent-context/zz-challenges/archive/12-datalog-vs-sql-sssom-chain-rules/)** — if Minigraf or CozoDB replaces Nemo, the Ch 12 commitment to "Nemo for SSSOM derivation" needs to flip to the replacement.
- **Independent of [Challenge 13](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/)** — different layer of architecture.
