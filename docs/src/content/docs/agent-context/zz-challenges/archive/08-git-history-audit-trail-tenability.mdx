...
date: 2026-05-01
sidebar:
  label: "Ch 08 · Git audit-trail tenability"
  order: 1008
---

:::tip[Resolved 2026-05-02 — archived]
Resolved by the [Ch 08 deliverable](/crosswalker/agent-context/zz-research/2026-05-02-challenge-08-git-audit-trail/) (augment-not-replace verdict: TSA + WORM + cert-export at Tier 1) and absorbed into the [v0.1 stack-pivot §3.1 audit-trail decision](/crosswalker/agent-context/zz-log/2026-05-02-v0-1-initial-stack-pivot/) (T1 = git + signed commits as v0.1 default; T2/T3 audit profiles as opt-in compliance-export mode). Follow-on at [archived Ch 13 (modern attestation primitives)](/crosswalker/agent-context/zz-challenges/archive/13-modern-attestation-primitives/) and [archived Ch 15 (non-git audit alternatives)](/crosswalker/agent-context/zz-challenges/archive/15-non-git-audit-trail-alternatives/). Brief preserved as originally written.
:::
