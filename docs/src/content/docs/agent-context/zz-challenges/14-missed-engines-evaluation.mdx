---
title: "Challenge 14: Missed engines evaluation — Grafeo, Minigraf, CozoDB, SurrealDB, Comunica, cr-sqlite"
description: "Phase 2 engine evaluation. Multiple engines surfaced during Challenge 11 research that were absent from the original brief — most consequentially Grafeo (pure-Rust LPG+RDF, all major query languages, vector index, WASM bindings, potentially collapses the layered Tier 2 stack to a single engine). Verify viability and recommend keep-the-Ch11-stack, swap-one-engine, or full-collapse-to-single-engine."
tags: [research, architecture, query-engine, tier-2, tier-3, follow-on, foundation]
date: 2026-05-02
sidebar:
  label: "14 · Missed engines"
---
