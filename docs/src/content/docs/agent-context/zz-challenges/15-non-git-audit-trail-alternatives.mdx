---
title: "Challenge 15: Audit-trail alternatives that don't require external git tooling"
description: "Ch 08 + Ch 13 audit-trail stack assumes git + a remote (GitHub/GitLab/etc.) — a hard assumption in air-gapped, locked-down enterprise, or government environments. Evaluate Obsidian-plugin-native audit-trail approaches that don't require external git, GitHub, or CLI tooling. Recommend keep / replace / layer vs the Ch 08+13 default."
tags: [research, audit, evidence-mapping-links, compliance, attestation, foundation]
date: 2026-05-02
sidebar:
  label: "15 · Non-git audit trail"
---
