...
- Knowledge organization meta-framework [**SEACOW**](https://github.com/cybersader/cyberbase) — lives in the `cybersader/cyberbase` public vault. See the [SEACOW + folder-tag-sync prior-art log](/crosswalker/agent-context/zz-log/2026-04-10-seacow-and-folder-tag-sync-prior-art/) for how it connects to Crosswalker's Foundation decisions.
- [**obsidian-folder-tag-sync**](https://github.com/cybersader/obsidian-folder-tag-sync) — the project owner's other active plugin (lives in the same `plugin_development/` workspace as Crosswalker) that provides bidirectional folder↔tag sync for polyhierarchy. Direct reuse candidate for Crosswalker's generation engine — see the [prior-art log](/crosswalker/agent-context/zz-log/2026-04-10-seacow-and-folder-tag-sync-prior-art/) and the [roadmap research item](/crosswalker/reference/roadmap/).
