...
- [Challenge 07: Link metadata / edge model](/crosswalker/agent-context/zz-challenges/archive/07-link-metadata-edge-model/) — the fresh-agent research brief this resolved
