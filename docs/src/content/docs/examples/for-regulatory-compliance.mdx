...
- [For GRC / risk](/crosswalker/examples/for-grc-isrm/) — owns the controls you map obligations to
- [Control-centric vs obligation-centric compliance](/crosswalker/concepts/compliance-control-vs-obligation/) — obligation-centric (reg-CMS) vs control-centric (control ops); the tools for each
