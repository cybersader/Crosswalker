...
description: "Refactor generateFromRecipe + generateNotes to accept an AsyncIterable<Row> instead of accumulating ParsedData.rows[] in RAM. End-to-end streaming pipeline so multi-GB inputs work. Triggered by the 2026-05-05 two-mode architecture decision."
sidebar:
  order: 14.5
...
This is the implementation of Mode 1 (bundled projector) at scale, per the [2026-05-05 two-mode architecture decision](/crosswalker/agent-context/zz-log/2026-05-05-two-mode-architecture/). Without it, [ChunkyCSV / JSONaut](/crosswalker/concepts/etl-and-import/#why-both-modes-matter) composition with the bundled engine caps at RAM-sized inputs, defeating the purpose.

## Status

📋 Planning (next milestone after v0.1.4)
