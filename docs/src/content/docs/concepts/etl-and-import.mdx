...
|---|---|---|
| Bundle engine implementation language | Hybrid (TS in-plugin + Python external) | [Ch 23](/crosswalker/agent-context/zz-challenges/23-bundle-engine-language/) — research pending |
...
- [Ch 23 — Bundle engine language](/crosswalker/agent-context/zz-challenges/23-bundle-engine-language/) — TS in-plugin vs external Python vs hybrid
