...
- [Challenge 22 — Target-structure expressivity](/crosswalker/agent-context/zz-challenges/22-target-structure-expressivity/) — the open research question on how recipes compose these mechanisms
